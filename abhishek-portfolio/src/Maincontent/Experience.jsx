...
function Experience() {
  return (
    <div className="w-full flex flex-col items-center px-4 py-12 min-h-screen">
                ...
                <div className={`w-5/12 ${isLeft ? "flex flex-col items-end" : ""}`}>
                  {isLeft && (
                    <div className="text-right">
                      <h3 className="text-2xl font-extrabold text-white mb-1">{exp.role}</h3>
                      <div className="text-gray-400 text-lg mb-2">{exp.company}</div>
